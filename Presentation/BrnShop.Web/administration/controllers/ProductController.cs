...
namespace BrnShop.Web.Admin.Controllers
{
    ...
    public partial class ProductController : BaseAdminController
    {
        ...
        /// <returns></returns>
        public ActionResult OnSaleProductList(string productName, string categoryName, string brandName, int cateId = -1, int brandId = -1, int pageNumber = 1, int pageSize = 15)
        {
        ...
        public ActionResult DelProductKeyword(string keyword = "", int pid = -1)
        {
            ...
            AddAdminOperateLog("删除商品关键词", "删除商品关键词,商品ID:" + pid);
            return Content("1");
        }
