...
namespace BrnShop.Data
{
    ...
    public partial class Users
    {
        ...
        {
            return BrnShop.Core.BSPData.RDBS.AdminGetUserList(pageSize, pageNumber, condition);
        }
        ...
        /// </summary>
        /// <param name="uid">用户id.</param>
        public static void UpdateUserVerityEmailByUid(int uid)
        {
            BrnShop.Core.BSPData.RDBS.UpdateUserVerityEmailByUid(uid);
        }
