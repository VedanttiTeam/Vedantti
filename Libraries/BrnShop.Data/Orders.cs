...
namespace BrnShop.Data
{
    ...
    public partial class Orders
    {
        ...
        public static OrderProductInfo BuildOrderProductFromReader(IDataReader reader)
        {
            ...
            orderProductInfo.Gid = reader["gid"].ToString();
            ...
            orderProductInfo.Weight = TypeHelper.ObjectToDecimal(reader["weight"]);
        ...
        public static OrderInfo BuildOrderFromReader(IDataReader reader)
        {
            ...
            orderInfo.Weight = TypeHelper.ObjectToDecimal(reader["weight"]);
        ...
        {
            return BrnShop.Core.BSPData.RDBS.GetOrderList(pageSize, pageNumber, condition);
        }
        ...
        /// <param name="orderState">订单状态</param>
        /// <returns></returns>
        public static string GetOrderListCondition(string osn, int uid, string mobile, string consignee, int orderState)
        {
            return BrnShop.Core.BSPData.RDBS.GetOrderListCondition(osn, uid, mobile, consignee, orderState);
        }
        ...
        /// <returns></returns>
        public static bool HasBuyGoods(int uid)
        {
            return BrnShop.Core.BSPData.RDBS.HasBuyGoods(uid);
        }
        ...
        /// <returns></returns>
        public static void UpdateOrderProductGoodsID(int recordid,string gid)
        {
            BrnShop.Core.BSPData.RDBS.UpdateOrderProductGoodsID(recordid,gid);
        }
        ...
        {
            BrnShop.Core.BSPData.RDBS.PayOrder(oid, orderState, paySN, paySystemName, payFriendName, payTime);
            if (_ordernosql != null)
        ...
        {
            BrnShop.Core.BSPData.RDBS.AutoReceiveOrder(expireTime);
        }
        ...
        {
            return BrnShop.Core.BSPData.RDBS.GetSaleProductList(pageSize, pageNumber, startTime, endTime, orderState);
        }
        ...
        {
            return BrnShop.Core.BSPData.RDBS.GetSaleProductCount(startTime, endTime, orderState);
        }
        ...
        {
            return BrnShop.Core.BSPData.RDBS.GetOrderStat(statType, startTime, endTime);
        }
    }
}
