...
namespace BrnShop.Core
{
    ...
    public partial interface IShipPlugin : IPlugin
    {
        ...
        /// <returns></returns>
        decimal GetShipFee(decimal totalWeight, decimal productAmount, List<OrderProductInfo> orderProductList, DateTime buyTime, int provinceId, int cityId, int countyId, PartUserInfo partUserInfo);
    }
}
