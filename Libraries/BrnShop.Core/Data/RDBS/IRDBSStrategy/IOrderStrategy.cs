...
namespace BrnShop.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <param name="orderState">订单状态</param>
        /// <returns></returns>
        string GetOrderListCondition(string osn, int uid,string mobile, string consignee, int orderState);
        ...
        /// <returns></returns>
        void UpdateOrderProductGoodsID(int recordid,string gid);
