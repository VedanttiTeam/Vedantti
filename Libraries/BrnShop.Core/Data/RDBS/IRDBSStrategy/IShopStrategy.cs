...
namespace BrnShop.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <param name="ip">ip</param>
        /// <returns></returns>
        DataTable AdminGetBannedIPList(int pageSize, int pageNumber, string ip);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        DataTable AdminGetNewsList(int pageSize, int pageNumber, string condition);
        ...
        /// </summary>
        /// <returns></returns>
        IDataReader GetShipCompanyList();

        /// <summary>
        /// 创建配送公司
        /// </summary>
        void CreateShipCompany(ShipCompanyInfo shipCompanyInfo);

        /// <summary>
        /// 更新配送公司
        /// </summary>
        void UpdateShipCompany(ShipCompanyInfo shipCompanyInfo);

        /// <summary>
        /// 删除配送公司
        /// </summary>
        /// <param name="shipCoId">配送公司id</param>
        void DeleteShipCompanyById(int shipCoId);
        ...
        /// </summary>
        /// <param name="creditLogInfo">积分日志信息</param>
        void SendPayCredits(CreditLogInfo creditLogInfo);
        ...
        /// <param name="ip">IP</param>
        bool SubscribeEmail(string email, string ip);

        /// <summary>
        /// 退订阅邮件
        /// </summary>
        /// <param name="email">电子邮件</param>
        bool DelSubscribeEmail(string email);
