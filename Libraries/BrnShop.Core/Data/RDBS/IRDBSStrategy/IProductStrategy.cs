...
namespace BrnShop.Core
{
    ...
    public partial interface IRDBSStrategy
    {
        ...
        /// <returns></returns>
        DataTable AdminGetBrandList(int pageSize, int pageNumber, string condition);
        ...
        /// <param name="cateId">分类id</param>
        /// <returns></returns>
        DataTable AdminGetAttributeList(int cateId);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        DataTable AdminGetProductList(int pageSize, int pageNumber, string condition);
        ...
        /// <param name="sortDirection">排序方向</param>
        /// <returns></returns>
        IDataReader GetCategoryProductList(int pageSize, int pageNumber, int brandId, int cateId, int onlyStock, int sortColumn, int sortDirection);
        ...
        /// <param name="onlyStock">是否只显示有货</param>
        /// <returns></returns>
        int GetBrandProductCount(int brandId, int cateId = 0, int onlyStock=0);
        ...
        /// 创建商品图片
        /// </summary>
        void CreateProductImage(ProductImageInfo productImageInfo);
        ...
        void DeleteProductImageById(int pImgId);
        ...
        /// <param name="pid">商品id</param>
        /// <param name="pImgId">商品图片id</param>
        void SetProductMainImage(int pid, int pImgId);
        ...
        void ChangeProductImageDisplayOrder(int pImgId, int displayOrder);
        ...
        /// </summary>
        /// <returns></returns>
        DataTable GetProductSubscribelist();
        ...
        /// <returns></returns>
        void DeleteProductSubscribeById(string SubscribeId);
        #endregion
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        IDataReader AdminGetProductConsultList(int pageSize, int pageNumber, string condition);
        ...
        /// <param name="condition">条件</param>
        /// <returns></returns>
        DataTable AdminGetProductReviewList(int pageSize, int pageNumber, string condition);
        ...
        /// <param name="word">搜索词</param>
        /// <returns></returns>
        DataTable GetSearchWordStatList(int pageSize, int pageNumber, string word);
