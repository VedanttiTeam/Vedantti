...
namespace BrnShop.Services
{
    ...
    public partial class Carts
    {
        ...
        /// <returns></returns>
        public static bool IsSelectedCartItem(int type, int id, string[] selectedCartItemKeyList)
        {
        ...
        /// <param name="orderProductList">订单商品列表</param>
        /// <returns></returns>
        public static CartInfo TidyOrderProductList(List<OrderProductInfo> orderProductList)
        {
            return TidyOrderProductList(null, orderProductList);
        }
        ...
        /// <param name="orderProductList">订单商品列表</param>
        /// <returns></returns>
        public static CartInfo TidyOrderProductList(string[] selectedCartItemKeyList, List<OrderProductInfo> orderProductList)
        {
            //声明一个购物车
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (orderProductInfo.Type == 0)//当商品是普通订单商品时
                {
                    if (orderProductInfo.ExtCode4 > 0)//满赠订单商品处理
                    {
                        ...
                        if (fullSendPromotionInfo != null)
                        {
                            ...
                            cartProductInfo1.IsSelected = IsSelectedCartItem(0, orderProductInfo.Pid, selectedCartItemKeyList);
                            ...
                            for (int j = 0; j < count; j++)
                            {
                                ...
                                if (item != null && item.Type == 0 && item.ExtCode4 == orderProductInfo.ExtCode4)
                                {
                                    ...
                                    cartProductInfo2.IsSelected = IsSelectedCartItem(0, item.Pid, selectedCartItemKeyList);
                            ...
                            {
                                if (fullSendMainCartProductInfo.IsSelected)
                            ...
                            cartInfo.CartFullSendList.Add(cartFullSendInfo);
                        }
                        else//当满赠促销活动不存在时，按照没有满赠促销商品处理
                        {
                            ...
                            cartInfo.CartProductList.Add(cartProductInfo1);
                            ...
                            for (int j = 0; j < count; j++)
                            {
                                ...
                                if (item != null && item.Type == 0 && item.ExtCode4 == orderProductInfo.ExtCode4)
                                {
                                    ...
                                    cartInfo.CartProductList.Add(cartProductInfo2);
                                }
                            }
                    ...
                    else if (orderProductInfo.ExtCode5 > 0)//满减订单商品处理
                    {
                        ...
                        if (fullCutPromotionInfo != null)
                        {
                            ...
                            {
                                if (fullCutCartProductInfo.IsSelected)
                            ...
                            cartInfo.CartFullCutList.Add(cartFullCutInfo);
                        }
                    ...
                    else//非满赠和满减订单商品处理
                    {
                        ...
                        cartProductInfo.IsSelected = IsSelectedCartItem(0, orderProductInfo.Pid, selectedCartItemKeyList);
                        ...
                        cartInfo.CartProductList.Add(cartProductInfo);
                ...
                else if (orderProductInfo.Type == 3)//当商品是套装商品时
                {
                    ...
                    cartSuitInfo.IsSelected = IsSelectedCartItem(1, orderProductInfo.ExtCode1, selectedCartItemKeyList);
                    ...
                    for (int j = 0; j < count; j++)
                    {
                        ...
                        if (item != null && item.Type == 3 && item.ExtCode1 == orderProductInfo.ExtCode1)
                        {
                            ...
                            CartProductInfo cartProductInfo = new CartProductInfo();
                            cartProductInfo.IsSelected = cartSuitInfo.IsSelected;
                    ...
                    cartInfo.CartSuitList.Add(cartSuitInfo);
            ...
            foreach (CartProductInfo cartProductInfo in cartInfo.CartProductList)
            {
                ...
                {
                    cartInfo.SelectedOrderProductList.Add(cartProductInfo.OrderProductInfo);
                    cartInfo.SelectedOrderProductList.AddRange(cartProductInfo.GiftList);
                }
                else
                {
                    cartInfo.RemainedOrderProductList.Add(cartProductInfo.OrderProductInfo);
                    cartInfo.RemainedOrderProductList.AddRange(cartProductInfo.GiftList);
                }
            }
            ...
            foreach (CartFullSendInfo cartFullSendInfo in cartInfo.CartFullSendList)
            {
                if (cartFullSendInfo.FullSendMinorOrderProductInfo != null)
                {
                    ...
                    {
                        cartInfo.SelectedOrderProductList.Add(cartFullSendInfo.FullSendMinorOrderProductInfo);
                    }
                    else
                    {
                        cartInfo.RemainedOrderProductList.Add(cartFullSendInfo.FullSendMinorOrderProductInfo);
                    }
                }
        ...
        /// <param name="orderProductList">订单商品列表</param>
        /// <returns></returns>
        public static decimal SumOrderProductWeight(List<OrderProductInfo> orderProductList)
        {
        ...
        /// 汇总满减
        /// </summary>
        /// <param name="cartInfo">购物车信息</param>
        /// <returns></returns>
        public static int SumFullCut(CartInfo cartInfo)
        {
            //满减
            int fullCut = 0;
            foreach (CartFullCutInfo cartFullCutInfo in cartInfo.CartFullCutList)
        ...
        /// <param name="orderProductInfo">订单商品</param>
        /// <returns></returns>
        public static List<OrderProductInfo> UpdateGiftOrderProduct(List<OrderProductInfo> orderProductList, OrderProductInfo orderProductInfo)
        {
        ...
        public static void AddExistProductToCart(ref List<OrderProductInfo> orderProductList, int buyCount, OrderProductInfo orderProductInfo, DateTime buyTime)
        {
            ...
            //更新订单商品的赠品促销活动
            List<OrderProductInfo> giftOrderProductList = UpdateGiftOrderProduct(orderProductList, orderProductInfo);
        ...
        public static void AddExistSuitToCart(ref List<OrderProductInfo> orderProductList, List<OrderProductInfo> suitOrderProductList, int buyCount)
        {
            ...
            foreach (OrderProductInfo orderProductInfo in suitOrderProductList)
            {
                ...
                {
                    orderProductInfo.BuyCount = buyCount * orderProductInfo.ExtCode2;
                    orderProductInfo.RealCount = buyCount * orderProductInfo.ExtCode2;
                }
                else if (orderProductInfo.Type == 2)//赠品
                {
                    orderProductInfo.RealCount = buyCount * orderProductInfo.ExtCode2;
                }
                list.Add(orderProductInfo);
