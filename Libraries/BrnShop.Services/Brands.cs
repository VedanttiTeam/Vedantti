...
namespace BrnShop.Services
{
    ...
    public partial class Brands
    {
        ...
        {
            List<CategoryInfo> categoryList = BrnShop.Core.BSPCache.Get(CacheKeys.SHOP_BRANDLIST_CATEGORY + brandId) as List<CategoryInfo>;
            if (categoryList == null)
            {
                categoryList = BrnShop.Data.Brands.GetBrandCategoryList(brandId);
                if (categoryList != null)
                    BrnShop.Core.BSPCache.Insert(CacheKeys.SHOP_BRANDLIST_CATEGORY + brandId, categoryList);
            }
