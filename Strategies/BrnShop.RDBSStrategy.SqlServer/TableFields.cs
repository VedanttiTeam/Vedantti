...
namespace BrnShop.RDBSStrategy.SqlServer
{
    ...
    internal partial class TableFields
    {
        ...
        /// 新闻表
        /// </summary>
        public const string NEWS = "[newsid],[newstypeid],[isshow],[istop],[ishome],[displayorder],[addtime],[title],[image],[url],[body]";
        ...
        /// 订单售后服务表
        /// </summary>
        public const string ORDER_AFTERSERVICES = "[asid],[state],[uid],[oid],[recordid],[pid],[cateid],[brandid],[pname],[pshowimg],[count],[money],[type],[applyreason],[applytime],[checkresult],[checktime],[shipcoid1],[shipconame1],[shipsn1],[regionid],[consignee],[mobile],[phone],[email],[zipcode],[address],[sendtime],[receivetime],[shipcoid2],[shipconame2],[shipsn2],[backtime]";

        /// <summary>
        /// 订单退款表
        /// </summary>
        public const string ORDER_REFUNDS = "[refundid],[state],[oid],[osn],[uid],[asid],[paysystemname],[payfriendname],[paysn],[paymoney],[refundmoney],[applytime],[refundsn],[refundtime]";
        ...
        /// 商品部分表
        /// </summary>
        public const string PART_PRODUCTS = "[pid],[psn],[cateid],[brandid],[skugid],[name],[shopprice],[marketprice],[costprice],[state],[isbest],[ishot],[isnew],[displayorder],[weight],[showimg],[salecount],[visitcount],[reviewcount],0 [number],[star1],[star2],[star3],[star4],[star5],[addtime],'' [description]";
